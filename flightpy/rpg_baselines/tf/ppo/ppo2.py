...
#
from rpg_baselines.tf.common.policies import ActorCriticPolicy, RecurrentActorCriticPolicy
        ...
        with SetVerbosity(self.verbose):
            ...
            with self.graph.as_default():
                ...
                with tf.variable_scope("loss", reuse=False):
                    ...
                    neglogpac = train_model.proba_distribution.tanh_neglogp(
                        self.action_ph)
                    ...
                    loss = self.pg_loss - self.entropy * self.ent_coef + \
                        self.vf_loss * self.vf_coef  # + self.kl_loss
...
class Runner(AbstractEnvRunner):
    ...
    def _run(self):
        ...
        for _ in range(self.n_steps):
            tanh_action, actions, values, self.states, neglogpacs = self.model.step(
        ...
        # discount/bootstrap off value fd
